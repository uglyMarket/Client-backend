...
//        userLoginService = new UserLoginService(userRepository, jwtUtil);
//    }
//
//    // 회원가입 테스트
//    @Test
...
//
//        // when (검증하고 싶은 서비스 실행)
//        JoinResponse response = userLoginService.joinUser(request);
//
//        // then (response검증)
...
//
//        // when & then
//        assertThrows(CustomException.class, () -> userLoginService.joinUser(request));
//    }
//
//    // 로그인 테스트
//    @Test
